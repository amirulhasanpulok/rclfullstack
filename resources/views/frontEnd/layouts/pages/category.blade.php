                        ...
                        <div class="product_item wist_item">
                            <div class="product_item_inner">
                                ...
                                <div class="pro_des">
                                    <div class="pro_name">
                                        <a
                                    href="{{ route('product', $value->slug) }}">{{ Str::limit($value->name,40) }}</a>
                                    </div>
                                    <div class="pro_price">
                                        @if($value->variable_count > 0 && $value->type == 0)
                                             <p>
                            ...
                            @if($value->variable_count > 0 && $value->type == 0)
                                <div class="pro_btn">
                                    ...
                                    <div class="cart_btn order_button" style="background: #1a81b7;">
                                        <a style="background: #1a81b7;" href="{{ route('product', $value->slug) }}"
                                            class="addcartbutton">অর্ডার করুন </a>
                                    </div>
                                </div>
                            @else
                                <div class="pro_btn" style="background: #1a81b7;">

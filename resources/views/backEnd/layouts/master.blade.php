  ...
  <div id="wrapper">
      ...
      <div class="h-100" data-simplebar>
        ...
        <div id="sidebar-menu" style="background: black;">
          <ul id="side-menu">
            ...
            <li>
              ...
              <div class="collapse" id="siebar-product">
                <ul class="nav-second-level">
                  ...
                  <li>
                    <a href="{{route('model.index')}}"><i data-feather="file-plus"></i> Model </a>
                  </li>
                  <li>
                    <a href="{{route('weight.index')}}"><i data-feather="file-plus"></i> Weight </a>
                  </li>
                  ...
                  <li>
                    <a href="{{route('couponcodes.index')}}"><i data-feather="file-plus"></i> Coupon Code</a>
                  </li>
            ...
            <li>
              <a href="{{ route('categories.index') }}"><i data-feather="layers"></i> Categories</a>
            </li>
            <li>
              <a href="{{ route('subcategories.index') }}"><i data-feather="grid"></i> Subcategories</a>
            </li>
            <li>
              <a href="{{ route('childcategories.index') }}"><i data-feather="list"></i> Childcategories</a>
            </li>
            <li>
              <a href="{{ route('brands.index') }}"><i data-feather="tag"></i> Brands</a>
            </li>
    ...
    <div class="content-page">
      ...
      <footer class="footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 text-end">© Nicola Tech / All rights reserved. Developed by CodexLab BD.</div>
          </div>
        </div>
      </footer>
      <!-- end Footer -->

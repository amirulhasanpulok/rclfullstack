          ...
          <form action="{{route('products.update')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data" name="editForm">
            ...
            <div class="col-sm-4">
              <div class="form-group mb-3">
                ...
                <select class="form-control select2 @error('type') is-invalid @enderror" value="{{ old('type') }}" id="product_type" name="type">
              ...
              <div class="row mb-2">
                <div class="col-sm-2">
                  <div class="form-group">
                    <label for="up_size" class="form-label">Size</label>
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    <label for="up_color" class="form-label">Weight (optional)</label>
                    <select class="form-control" name="weight[]">
                      <option value="">Select</option>
                      @foreach($weight as $item)
                      <option value="{{$item->title}}" @if($variable->weight == $item->title) selected @endif >{{$item->title}}</option>
                      @endforeach
                    </select>
                    @error('title')
                    <span class="invalid-feedback" role="alert">
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    <label for="up_color" class="form-label">Model (optional)</label>
                    <select class="form-control" name="model[]">
                      <option value="">Select</option>
                      @foreach($model as $item)
                      <option value="{{$item->title}}" @if($variable->model == $item->title) selected @endif >{{$item->title}}</option>
                      @endforeach
                    </select>
                    @error('up_color')
                    <span class="invalid-feedback" role="alert">
                ...
                <div class="col-sm-8">
                  <label for="up_images"> Image (optional) </label>
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="weight[]">
                      <option value="">Select</option>
                      @foreach($weight as $item)
                      <option value="{{$item->title}}" @if($variable->color == $item->title) selected @endif >{{$item->title}}</option>
                      @endforeach
                    </select>
                    @error('title')
                    <span class="invalid-feedback" role="alert">
            ...
            <div class="col-sm-3 mb-3">
              <div class="form-group">
                ...
                <label class="switch">
                  <input type="checkbox" value="1" name="free_shipping" @if($edit_data->free_shipping==1)checked @endif>
                  <span class="slider round"></span>
                </label>
                @error('free_shipping')
                <span class="invalid-feedback" role="alert">
